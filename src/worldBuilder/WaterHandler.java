...
public class WaterHandler extends State{
    ...
    @Override
    void render() {
        // fill in the circles with a slightly blue fill
        instance.fill(0, 0, 255, 50);
        instance.noStroke();
    ...
    void keyPressed() {
        if(instance.key == 'z') {
            ...
            instance.curState = null;
            instance.waterCircles = circles;
        }
    }

    @Override
    String getInstructions() {
        return "left click to set the center of the circle of a part of the water, click again to set the size of the circle (denoted by the outline). Press 'z' to undo, and any other key to continue";
    }
